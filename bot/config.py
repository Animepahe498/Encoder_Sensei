...
class Config(object):
    ...
    LOG_CHANNEL = get_config("LOG_CHANNEL" "line_encode")
    UPDATES_CHANNEL = get_config("UPDATES_CHANNEL", None) # Without `@` LOL
     # Get these values from my.telegram.org
    AUTH_USERS = get_config("AUTH_USERS", "-1001917098257,5086525318,6446763201,961551026,760067286,6066177103")
# array , simplest method was AUTH_USERS = [] ; AUTH_USERS.append(your telegram id) 🤣
    # array to store the channel ID who are authorized to use the bot
    # dont u fucking remove this id 😤
    TG_BOT_TOKEN = get_config("TG_BOT_TOKEN", "6857043537:AAHjGipLBBO5KpxkvDVtr9eGtEDYCHFoSeY")
    # the download location, where the HTTP Server runs
    DOWNLOAD_LOCATION = get_config("DOWNLOAD_LOCATION", "/app/downloads")
    # Telegram maximum file upload size
    BOT_USERNAME = get_config("BOT_USERNAME", "Encode_720xbot")
